...
const LandingPage = () => {
  ...
  return (
    <section className="relative w-full min-h-[100dvh] overflow-hidden">
      ...
      <div className="absolute inset-0 w-full flex items-center justify-center bg-black/40 dark:bg-black/40">
        <div className="relative flex flex-col items-center justify-center w-full max-w-7xl px-6 text-center text-white gap-y-4 mb-25">
